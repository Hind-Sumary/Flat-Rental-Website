...
$page_title = "Owner Registration - Step 1 - Birzeit Flat Rent";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        $_SESSION['registration_data']['user_type'] = 'owner'; // Mark as owner registration
...
<h2>Owner Registration - Step 1: Personal Details</h2>
...
<form action="register_owner_step1.php" method="POST" class="registration-form">
    <fieldset>
